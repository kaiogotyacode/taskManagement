        ...
        <div class="adm-projects-content">
            ...
            if ($retornoAdmListProj->num_rows > 0) {
                while ($rowAdm = $retornoAdmListProj->fetch_assoc()) {
                    print "
                                <div class='adm-project-option' onclick=\"
                                if(confirm('Você realmente deseja gerenciar o projeto \'" . $rowAdm["nome"] . "\'? '))
                                    {  
                                        window.location.href=('management.php?idProjeto=" . $rowAdm['idProjeto'] . "');
                                    }
                                else{
                                       return false;
                                }
